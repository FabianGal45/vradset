...
class AdvertisementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create advertisement" do
    assert_difference("Advertisement.count") do
      post advertisements_url, params: { advertisement: { description: @advertisement.description, title: @advertisement.title, url: @advertisement.url } }
    end
  ...
  test "should update advertisement" do
    patch advertisement_url(@advertisement), params: { advertisement: { description: @advertisement.description, title: @advertisement.title, url: @advertisement.url } }
